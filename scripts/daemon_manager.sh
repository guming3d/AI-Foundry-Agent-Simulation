...
DAEMON_SCRIPT="$SCRIPT_DIR/simulation/daemon.py"
PID_FILE="$PROJECT_ROOT/data/daemon_results/daemon.pid"
LOG_DIR="$PROJECT_ROOT/data/daemon_results"
CONFIG_FILE="$PROJECT_ROOT/config/daemon_config.json"
...
function start_daemon() {
    ...
    # Change to project root for proper relative imports
    cd "$PROJECT_ROOT"

    # Start daemon in background
    nohup "$PYTHON" "$DAEMON_SCRIPT" --config "$CONFIG_FILE" \
