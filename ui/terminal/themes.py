...
CYBER_OPS = Theme(
    ...
    surface="#0B0E12",       # Matches background
    panel="#0B0E12",         # Matches background
...
AZURE_DARK = Theme(
    ...
    surface="#1E1E1E",       # Matches background
    panel="#1E1E1E",         # Matches background
...
AZURE_LIGHT = Theme(
    ...
    surface="#FFFFFF",       # Matches background
    panel="#FFFFFF",         # Matches background
...
NORD = Theme(
    ...
    surface="#2E3440",       # Matches background
    panel="#2E3440",         # Matches background
...
GRUVBOX_DARK = Theme(
    ...
    surface="#282828",       # Matches background
    panel="#282828",         # Matches background
...
TOKYO_NIGHT = Theme(
    ...
    surface="#1A1B26",       # Matches background
    panel="#1A1B26",         # Matches background
...
HIGH_CONTRAST = Theme(
    ...
    surface="#000000",       # Matches background
    panel="#000000",         # Matches background
...
SOLARIZED_DARK = Theme(
    ...
    surface="#002B36",       # Matches background
    panel="#002B36",         # Matches background
...
SOLARIZED_LIGHT = Theme(
    ...
    surface="#FDF6E3",       # Matches background
    panel="#FDF6E3",         # Matches background
    success="#859900",       # Solarized Green
    warning="#B58900",       # Solarized Yellow
    error="#DC322F",         # Solarized Red
    dark=False,
...
DRACULA = Theme(
    ...
    surface="#282A36",       # Matches background
    panel="#282A36",         # Matches background
